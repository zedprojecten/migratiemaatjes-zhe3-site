 ...
 * Component: https://21st.dev/community/components/easemize/ai-prompt-box/default
 *
 * Code 1:1 overgenomen onder de open-source registry-licentie van 21st.dev.
 * Vereist: @radix-ui/react-tooltip, @radix-ui/react-dialog, framer-motion,
 * lucide-react (al in site-template deps).
 */
