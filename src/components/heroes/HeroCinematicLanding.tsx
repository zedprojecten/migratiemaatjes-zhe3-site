/**
 * HeroCinematicLanding, full-page cinematic hero met GSAP scroll-timeline,
 * iPhone mockup en silver-matte text reveals.
 *
 * Bron: 21st.dev community registry
 * Author: easemize (https://21st.dev/community/easemize)
 * Component: https://21st.dev/community/components/easemize/cinematic-landing-hero/default
 *
 * Code overgenomen onder de open-source registry-licentie van 21st.dev.
 * Lokale aanpassingen:
 *  - "use client" directive verwijderd (Vite, geen Next.js)
 *  - var(--color-foreground) → var(--foreground) (Tailwind v4 → v3 token)
 *  - Voor de rest 1:1 zoals de auteur het schreef
 */
...
export interface HeroCinematicLandingProps extends React.HTMLAttributes<HTMLDivElement> {
  brandName?: string;
  tagline1?: string;
  tagline2?: string;
  cardHeading?: string;
...
export function HeroCinematicLanding({ 
  brandName = "Sobers",
